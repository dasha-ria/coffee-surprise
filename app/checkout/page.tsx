...
export default function Checkout() {
  ...
  return (
    <div className="pt-20 md:pt-32 pl-4 md:pl-10 ">
      <div>
        <Form
          onSubmit={onSubmit}
          render={({ handleSubmit, hasValidationErrors }) => (
            <form className="mt-2" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="disabled:bg-theme-red/20 mt-8 mb-20 py-2 px-4 w-20 rounded-full bg-theme-red text-white"
